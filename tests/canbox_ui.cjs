...
(async()=>{
 ...
 try{
  ...
  const can={mode:true,saved:true,connected:true,fresh:true,pending:false,ready:true,authorized:true,phase:'closed',session:'9007199254740993',detail:0};
  let tick=0;
  ...
  can.phase='idle';can.ready=false;await page.evaluate(()=>refresh());
