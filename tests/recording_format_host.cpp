...
int main(int argc,char** argv){
    ...
    assert(sessionId(1788864937000000ULL,0x4ee24d5b,0x9ebc8459)=="r1s3_2026-09-08_10-55-37_+0000_4ee24d5b_9ebc8459");
    assert(sessionId(951782400123456ULL,0,1)=="r1s3_2000-02-29_00-00-00_+0000_00000000_00000001");
    assert(sessionId(2147483648000000ULL,0,2)=="r1s3_2038-01-19_03-14-08_+0000_00000000_00000002");
    assert(sessionId(951782400000000ULL,0,1,-60)=="r1s3_2000-02-28_23-00-00_-0100_00000000_00000001");
    assert(sessionId(1788864937000000ULL,0,1,120)=="r1s3_2026-09-08_12-55-37_+0200_00000000_00000001");
