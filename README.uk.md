...
Відновлений Logger R1 на **ESP32-S3 + INA228**. Поточний етап — hardware bring-up, прошивка **HWTEST v0.10**. Старий код R1 ще не перенесено.
...
| INA228 | ID і три свіжі вимірювання АЦП успішні; звірка напруги, калібрування струму й ALERT попереду |
