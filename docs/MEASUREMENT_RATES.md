...
The subsequent preview adjustment (`ab1e7d0`) was tested through the USB bridge during the long run: all 76 observations at RUNNING/300 Hz were fresh, median 59.83 FPS, no browser errors. USB deliberately marks skipped preview windows; all ADC samples remain in the verified file.

After the owner replaced the USB cable and reconnected UART, the final clean v0.22 build `ab1e7d0457238221d81c99c30223e886df434139` uploaded successfully on COM5 with Flash hash verification. Firmware SHA-256: `ed9697924b8f914b5144111ad9a38990cc54a982d7a4ef8778c5055a066d06fd`. This completes deployment of the revised embedded panel.

Direct Wi-Fi acceptance on that final build used the embedded page at a 390 × 844 mobile viewport: manual 300 Hz, Apply, Start and Stop. All **25/25** sampled graph observations were fresh, median rendering rate **59.90 FPS**, no browser errors, zero missed/invalid samples or FIFO overflows, and 98 OLED frames. The first CSV download timed out; a separate retry downloaded the complete 1,737,293-byte file in 9.969 seconds and restored the PC's original network.

The final record `r1s3_2026-09-08_15-27-02Z_3047473d_f5b0eb2c_0000.csv` contains **8,376 verified rows at 300.029294 Hz**. Both readers confirm clean closure, integrity, raw values and integration, with zero missing sequences, invalid rows or gap rows. File SHA-256: `aef5a75c9cd200e3377e2da3a6ddf307cb667b16eb58b0e7c1b91e004af58a05`. Read-time intervals were 2587–4092 µs (median 3335 µs, p99 3492 µs). Together with the initial 15 files, acceptance now covers **16 files, 69,135 rows and 14,411,655 bytes**.
