...
// Local calendar with explicit offset in a FAT-safe name; preserve unique suffix.
std::string sessionId(uint64_t utcUs, uint32_t randomHi, uint32_t randomLo, int32_t localOffsetMin = 0);
struct SessionInfo {
